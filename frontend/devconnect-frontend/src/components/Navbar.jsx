...
const Navbar = (props) => {
  ...
  <aside
    id="default-sidebar"
    className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 border-inherit border-r"
    aria-label="Sidebar"
  > 
    <div className="h-full px-3 py-4 overflow-y-auto bg-zinc-900">
      ...
      <ul className="space-y-2 font-medium">
        ...
        <li>
          <button
            onClick={logout}
            className="flex items-center p-2 pr-32 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
