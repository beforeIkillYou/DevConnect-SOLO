    ...
    return (
        <>  
            ...
            <div className='bg-zinc-950 ml-64  text-white h-screen overflow-y-auto no-scrollbar'>
                ...
                <img src="https://i.pinimg.com/originals/67/44/8a/67448a616be5f3a983140458289bfa14.gif" className='w-auto h-auto items-center my-20 mx-[26vw] bg-blend-multiply'></img>
            </div>
        </>
    );
}
